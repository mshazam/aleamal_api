...
if($con)
{
    !empty($_POST['task_id']) ? $formData['task_id'] = $_POST['task_id'] : $errormsg[] = 'task_id is missing';
...
//  print_r($errormsg);die();
    ...
    //     }
        ...
        $q="UPDATE tasks set
                            ...
                            pick_up_latitude = '".$formData['pick_up_latitude']."',
                            pick_up_longnitude = '".$formData['pick_up_longnitude']."',
                            drop_up_latitude = '".$formData['drop_up_latitude']."',
                            drop_up_longnitude = '".$formData['drop_up_longnitude']."',
                            due_date = '".$formData['due_date']."'
                            where task_id = '".$formData['task_id']."'";
