...
if($con)
{
    !empty($_POST['service_provider_id']) ? $formData['service_provider_id'] = $_POST['service_provider_id'] : $errormsg[] = 'User Id is missing';
    ...
    !empty($_POST['status']) ? $formData['status'] = $_POST['status'] : $errormsg[] = 'Status is missing';
        ...
        $q="UPDATE service_providers set
                            ...
                            where service_provider_id = '".$formData['service_provider_id']."'";
